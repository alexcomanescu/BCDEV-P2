...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == _msgSender() ||  ownerOf(_tokenId2) == _msgSender(), "The sender must own one of the tokens");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == _msgSender(), "The sender must own the token");
